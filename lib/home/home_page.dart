              ...
              child: Align(
                  ...
                  child: Container(
                      ...
                      child: Center(
                          child: FittedBox(
                        fit: BoxFit.fitWidth,
                        child: Text('Copyright @ U-SAC 2023',
  ...
  _buildBody(int position, double fontsize) {
    switch (position) {
                                    ...
                                    Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                            builder: (context) => MapPage(
                                                ...
                                                keyHead: 0,
                                                longitudes:
                                                    longitudes__power_generation_projects,
                                                latitudes:
                                                    latitudes__power_generation_projects)));
                                  },
                                  child: Container(
                                    ...
                                    Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                            builder: (context) => MapPage(
                                                ...
                                                keyHead: 3,
                                                longitudes:
                                                    longitudes_solar_power_plants,
                                                latitudes:
                                                    latitudes_solar_power_plants)));
                                  },
                                  child: Container(
                                    decoration: const BoxDecoration(
                                        image: DecorationImage(
                    ...
                    child: Column(
                      children: [
                        ...
                        ListTile(
                          ...
                          title: InkWell(
                            child: Text(
                              'director-usac@uk.gov.in',
                              style: TextStyle(fontSize: fontsize),
                            ),
                            onTap: () {
                              launchUrl(
                                  Uri.parse('mailto:director-usac@uk.gov.in'));
                            },
                          ),
                        ),
                        const Divider(),
                        ...
                        ListTile(
                            ...
                            onTap: () {
                              var emailLink = 'mailto:usac_hq@yahoo.co.in';
      ...
      case 9:
        return WillPopScope(
            child:
                Center(child: SfPdfViewer.asset('assests/pdf_maps/atlas.pdf')),
            onWillPop: () async {
              _onItemTapped(0, 'Home');
              return Future.value(false);
            });
